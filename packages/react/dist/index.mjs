...
var TextInput = forwardRef4(
  (_a, ref) => {
    ...
    return /* @__PURE__ */ jsxs2(TextInputContainer, { className: isDisabled ? "disabled" : "", size, children: [
...
function Checkbox2(props) {
  return /* @__PURE__ */ jsx3(CheckboxContainer, __spreadProps(__spreadValues({}, props), { children: /* @__PURE__ */ jsx3(CheckboxIndicator, { asChild: true, children: /* @__PURE__ */ jsx3(Check_esm_default, { weight: "bold" }) }) }));
}
